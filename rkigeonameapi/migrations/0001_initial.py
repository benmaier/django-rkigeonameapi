    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fcode', models.ForeignKey(blank=True, db_column='fcode', null=True, on_delete=django.db.models.deletion.CASCADE, to='rkigeonameapi.Featurecode')),
                ('geonameid', models.ForeignKey(blank=True, db_column='geonameid', null=True, on_delete=django.db.models.deletion.CASCADE, to='rkigeonameapi.Geoname')),
                ('laender', models.ManyToManyField(to='rkigeonameapi.Countryinfo')),
            ],
            options={
                'verbose_name': 'Region',
